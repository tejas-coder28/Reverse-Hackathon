      ...
      <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-4 px-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex h-[26px] w-[26px] items-center justify-center border border-rule-500 bg-paper-100 text-ink-700 transition-colors hover:border-rule-600 hover:text-ink-900"
            style={{ borderRadius: 2 }}
          >
